...
<body>
  ...
  <div class="container">
    <div class="judul">
      <h2>Daftar Alumni SMK Krian 1<br />Sidoarjo</h2>
    </div>
    ...
    <div class="form-ulasan">
      <form id="formUlasan">
        ...
        <div class="isi-form">
          ...
          <textarea id="ulasan" rows="4" required></textarea>
        </div>

        <input type="hidden" id="nilaiRating" name="nilaiRating" />
        <button type="submit" class="submit">Kirim Ulasan</button>
      </form>
    </div>
  </div>
  ...
  <script src="../assets/js/ulasan_alumni.js"></script>
</body>
